...
class _CreateUserWidgetState extends State<CreateUserWidget> {
  ...
  void initState() {
    ...
    _model.emailIdNewTextController ??= TextEditingController();
    _model.emailIdNewFocusNode ??= FocusNode();
                              ...
                              Flexible(
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 15.0, 0.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.emailIdNewTextController,
                                    focusNode: _model.emailIdNewFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Email id',
                                    ...
                                    validator: _model
                                        .emailIdNewTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        final user = await authManager.createAccountWithEmail(
                          context,
                          _model.emailIdNewTextController.text,
